...
public class City
{
   ...
   /*
    * public CityWeather getWeather() { return weather; }
    * 
    * public void setWeather(CityWeather weather) { this.weather = weather; }
    */
   ...
   public boolean equals(Object obj) {
      ...
      if (population != other.population)
         return false;
      /*
       * if (weather == null) { if (other.weather != null) return false; } else if
       * (!weather.equals(other.weather)) return false;
       */
      return true;
   }
